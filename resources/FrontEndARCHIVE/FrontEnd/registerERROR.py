...
class MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        It is preferable not to use any of the following: 
        common english words, your name, your date of birth, 
        your phone number, your username, AUB, Lebanon, or any 
        character patterns such as qwerty or 12345 
        """
        
        problem_layout = QHBoxLayout()
        
        # redTextField = QWidget()
        ...
        """)
        #actualText.setContentsMargins(0,0,0,0)
        actualText.setReadOnly(True)
        actualText.setFixedSize(400, 270)
        ...
        mainlayout.addLayout(problem_layout, 0, 0, alignment=Qt.AlignCenter)
